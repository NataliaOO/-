...
Suite *test_sscanf_o(void) {
  ...
  tcase_add_test(tc, sscanf_spec_hho);
  tcase_add_test(tc, sscanf_spec_ho);
  tcase_add_test(tc, sscanf_spec_o);
  tcase_add_test(tc, sscanf_spec_lo);
  tcase_add_test(tc, sscanf_spec_llo);
